        ...
        <div className="relative z-10 px-4 sm:px-6 py-6 sm:py-8 flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-2xl space-y-3 sm:space-y-4 mb-6">
            {game.options.map(opt => (
              ...
              >
                <div className="flex items-center gap-1 text-[#F37021] font-black text-sm sm:text-xl uppercase pl-2 sm:pl-4 whitespace-nowrap">
                  <span>{opt.jogos} JOGOS</span>
                  <span className="text-gray-400 mx-0.5">/</span>
                  <span>{opt.dezenas} DEZENAS</span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                  <div className="bg-[#F37021] text-white px-2.5 sm:px-4 py-1 rounded-full font-black text-sm sm:text-xl shadow-inner text-center whitespace-nowrap">
