          ...
          <div className="w-full max-w-2xl space-y-3 sm:space-y-4 mb-6">
            {game.options.map(opt => (
              <div
                ...
                className="group lotomania-pill rounded-full border-[3px] border-[#d49e2a] px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2 sm:gap-4 transition-transform hover:scale-[1.02] cursor-pointer"
              >
                <div className="flex items-center gap-1 sm:gap-2 text-[#F37021] font-black text-base sm:text-xl uppercase flex-1 pl-2 sm:pl-4">
                  <span>{opt.jogos} JOGOS</span>
                  <span className="text-gray-400 text-sm">/</span>
                  <span className="text-sm sm:text-base">{opt.dezenas} DEZENAS</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                  <div className="bg-[#F37021] text-white px-3 sm:px-4 py-1 rounded-full font-black text-base sm:text-xl shadow-inner min-w-[100px] sm:min-w-[120px] text-center">
