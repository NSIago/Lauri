        ...
        <div className="relative z-10 px-4 sm:px-6 py-6 sm:py-8 flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-2xl space-y-3 sm:space-y-4 mb-6">
            {game.options.map(opt => (
              ...
              >
                <div className="quina-pill rounded-full border-[3px] border-[#d49e2a] px-3 sm:px-5 py-3 flex items-center justify-between flex-1 transition-transform hover:scale-[1.01] relative overflow-hidden min-w-0">
                  <span className="relative z-10 text-[#262196] font-black text-sm sm:text-xl uppercase whitespace-nowrap">
                    {opt.jogos} JOGOS
                  </span>
                  <span className="relative z-10 text-gray-400 font-bold mx-1 sm:mx-2 text-sm">/</span>
                  <span className="relative z-10 text-[#262196] font-black text-sm sm:text-xl uppercase whitespace-nowrap flex-1 text-left">
                    {opt.dezenas} DEZENAS
                  </span>
                  <div className="relative z-10 bg-[#262196] text-white px-3 sm:px-5 py-1 sm:py-1.5 rounded-full font-black text-sm sm:text-lg shadow-inner whitespace-nowrap ml-2">
