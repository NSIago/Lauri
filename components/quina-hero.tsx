...
export function QuinaHero({ game }: { game: Game }) {
  ...
  return (
    <div className="relative w-full">
      <div className="rounded-3xl border-[6px] border-[#d49e2a] shadow-[0_0_30px_rgba(38,33,150,0.6)] bg-quina-texture relative overflow-hidden">
        ...
        <div className="relative z-10 px-6 py-8 flex flex-col items-center text-center">
          <div className="mb-4 flex flex-col items-center">
            <div className="flex items-center gap-2 mb-2">
              <div className="text-[#8a8aff] bg-white/10 rounded-full p-2">
            ...
            <div className="text-white font-bold text-sm md:text-base tracking-wide bg-[#151166]/50 px-4 py-1 rounded-full border border-[#d49e2a]/30">
          ...
          <div className="w-full max-w-2xl space-y-4">
            {game.options.map(opt => (
              <div key={opt.id} onClick={() => addToCart(game, opt)} className="group quina-pill rounded-full border-[3px] border-[#d49e2a] px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 transition-transform hover:scale-[1.02] cursor-pointer">
                <div className="flex flex-col md:flex-row items-center gap-2 text-[#262196] font-black text-lg md:text-xl uppercase flex-1 justify-center md:justify-start pl-0 md:pl-4">
                  <span>{opt.jogos} JOGOS</span>
                  <span className="hidden md:inline text-gray-400">/</span>
                  <span>{opt.dezenas} DEZENAS</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="bg-[#262196] text-white px-4 py-1 rounded-full font-black text-xl shadow-inner min-w-[120px]">
