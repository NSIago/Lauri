          ...
          <div className="w-full max-w-2xl space-y-3 sm:space-y-4 mb-6">
            {game.options.map(opt => (
              <div
                ...
                className="group quina-pill rounded-full border-[3px] border-[#d49e2a] px-3 sm:px-5 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4 transition-transform hover:scale-[1.02] cursor-pointer"
              >
                <div className="flex items-center gap-1 text-[#262196] font-black text-sm sm:text-xl uppercase pl-1 sm:pl-2 whitespace-nowrap">
                  <span>{opt.jogos} JOGOS</span>
                  <span className="text-gray-400 mx-0.5">/</span>
                  <span>{opt.dezenas} DEZENAS</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                  <div className="bg-[#262196] text-white px-3 sm:px-5 py-1 sm:py-1.5 rounded-full font-black text-sm sm:text-lg shadow-inner text-center whitespace-nowrap">
