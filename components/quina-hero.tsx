...
export function QuinaHero({ game }: { game: Game }) {
  ...
  return (
    <div className="relative w-full">
      <div className="rounded-2xl sm:rounded-3xl border-4 sm:border-[6px] border-[#d49e2a] shadow-[0_0_30px_rgba(38,33,150,0.6)] bg-quina-texture relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4 opacity-30 mix-blend-overlay hidden sm:block">
          <span className="material-symbols-outlined text-white text-6xl rotate-12">theater_comedy</span>
        </div>
        ...
        <div className="relative z-10 px-4 sm:px-6 py-6 sm:py-8 flex flex-col items-center text-center">
          ...
          <div className="mb-4 flex flex-col items-center">
            <div className="flex items-center gap-2 mb-2">
              <div className="text-[#8a8aff] bg-white/10 rounded-full p-1.5 sm:p-2">
                <span className="material-symbols-outlined text-3xl sm:text-4xl">local_activity</span>
              </div>
              <h2
            ...
            <div className="text-white font-bold text-xs sm:text-sm tracking-wide bg-[#151166]/50 px-4 py-1 rounded-full border border-[#d49e2a]/30">
          ...
          <div className="w-full max-w-2xl space-y-3 sm:space-y-4 mb-6">
            {game.options.map(opt => (
              <div
                ...
                className="group quina-pill rounded-full border-[3px] border-[#d49e2a] px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2 sm:gap-4 transition-transform hover:scale-[1.02] cursor-pointer"
              >
                <div className="flex items-center gap-1 sm:gap-2 text-[#262196] font-black text-base sm:text-xl uppercase flex-1 pl-2 sm:pl-4">
                  <span>{opt.jogos} JOGOS</span>
                  <span className="text-gray-400 text-sm">/</span>
                  <span className="text-sm sm:text-base">{opt.dezenas} DEZENAS</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                  <div className="bg-[#262196] text-white px-3 sm:px-4 py-1 rounded-full font-black text-base sm:text-xl shadow-inner min-w-[100px] sm:min-w-[120px] text-center">
                    R$ {opt.price.toFixed(2)}
                  </div>
                  <button
                    className="bg-[#00bb2d] hover:bg-[#009824] text-white p-2 rounded-full shadow-lg transition-transform active:scale-95"
