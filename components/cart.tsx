  ...
  return (
    <div className="sticky top-24 bg-white rounded-xl shadow-2xl overflow-hidden">
      <div className="bg-gray-100 p-4 border-b border-gray-200">
        <h3 className="text-xl font-black text-black uppercase text-center">Meu Carrinho</h3>
      </div>
      <div className="p-4 space-y-4">
        {cart.length === 0 ? (
          <p className="text-center text-gray-500 py-4 font-medium">Seu carrinho está vazio.</p>
        ) : (
          <>
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <span className="font-black text-green-700 text-xl">R$ {cartTotal.toFixed(2)}</span>
            </div>
            <button 
              onClick={handleWhatsAppCheckout}
              className="w-full bg-[#00bb2d] hover:bg-[#009824] text-white rounded-lg p-2 flex items-center justify-center gap-3 transition-colors shadow-lg group"
            >
              <span className="material-symbols-outlined !text-[36px]">chat</span>
              <div className="flex flex-col items-start leading-none py-1">
                <span className="font-black text-lg uppercase">Finalizar Pedido</span>
